#ifndef _UTILS_TRANSFORM_H
#define _UTILS_TRANSFORM_H
...
/// @brief represents the world position of an object
struct Transform {
public:
...
public:
    /// @brief extract position, rotation, scale matrices from TRS mat4
    /// @param trs TRS mat4
